...
def set_parameters_for_inference(module_rootdir, config_obj, trained_weights_path):
    ...
    from gnn_modules.neural_net.gnn.gnn_detector import Model_Training
    from gnn_modules.compute_features.grid_features import grid_properties
    from gnn_modules.set_configurations.common import get_device
